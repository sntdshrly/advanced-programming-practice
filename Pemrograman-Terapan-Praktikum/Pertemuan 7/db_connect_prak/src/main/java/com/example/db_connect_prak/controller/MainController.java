...
public class MainController implements Initializable {
    ...
    @FXML
    private TableView<Tbitem> tbView1;
    @FXML
    private TableColumn<Tbitem, Integer> tbColID;
    @FXML
    private TableColumn<Tbitem, String> tbColName;
    @FXML
    private TableColumn<Tbitem, Double> tbColPrice;
    @FXML
    private TableColumn<Tbitem, Tbcategory> tbColCategory;
    //declare var
    private CategoryDaoImpl categoryDao;
    private ItemDaoImpl itemDao;
    private ObservableList<Tbitem> items;
    private ObservableList<Tbcategory> categories;
    ...
    private Tbitem selectedItem; // utk mendapatkan data dari tb category
    ...
    public void onActionSave(ActionEvent actionEvent) {
        if (txtID.getText().trim().isEmpty() || txtName.getText().trim().isEmpty() || txtPrice.getText().trim().isEmpty() || txtAreaDescription.getText().trim().isEmpty() || comboCategory.getValue() == null) {
            ...
            item.setItemPrice(Double.parseDouble(txtPrice.getText().trim()));
    ...
    public void onActionUpdate(ActionEvent actionEvent) {
        if (txtID.getText().trim().isEmpty() || txtName.getText().trim().isEmpty() || txtPrice.getText().trim().isEmpty() || txtAreaDescription.getText().trim().isEmpty() || comboCategory == null) {
            ...
            selectedItem.setItemPrice(Double.parseDouble(txtPrice.getText().trim()));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tbColPrice.setCellValueFactory(data -> new SimpleDoubleProperty(data.getValue().getItemPrice()).asObject());
